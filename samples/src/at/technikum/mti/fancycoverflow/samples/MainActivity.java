...
import at.technikum.mti.fancycoverflow.samples.example.CustomFancyExample;
import at.technikum.mti.fancycoverflow.samples.example.MyViewGroupExample;
...
public class MainActivity extends ListActivity
{
	...
	/**
	 * TODO: Scan the example package for activities and show them
	 * automatically.
	 */
	private static class ExampleAdapter extends BaseAdapter
	{
		...
		{ SimpleExample.class, ViewGroupExample.class,
				ViewGroupReflectionExample.class, XmlInflateExample.class,
				MyViewGroupExample.class, CustomFancyExample.class };
		...
		public View getView(int i, View reusableView, ViewGroup viewGroup)
		{
			...
			} else
			{
				...
				final int listItemPadding = context.getResources()
						.getDimensionPixelSize(
								R.dimen.mainActivityListItemPadding);
				view = new TextView(context);
				view.setGravity(Gravity.CENTER_VERTICAL);
				view.setLayoutParams(new AbsListView.LayoutParams(
						AbsListView.LayoutParams.MATCH_PARENT, context
								.getResources().getDimensionPixelSize(
										R.dimen.mainActivityListItemHeight)));
