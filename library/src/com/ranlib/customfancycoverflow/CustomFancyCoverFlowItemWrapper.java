...
class CustomFancyCoverFlowItemWrapper extends ViewGroup
{
	...
	public CustomFancyCoverFlowItemWrapper(Context context)
	{
		super(context);
		this.init();
	}

	public CustomFancyCoverFlowItemWrapper(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		this.init();
	}
